...
### ⛏️🇨🇳 Following Zijin — Does Co-Investing Alongside China's Mining Champion Pay? (NEW — Sep 18, 2026)

Backtests a sharp thesis: the tradeable pattern is not "companies Zijin buys outright" (a takeover cashes you out once) but **listed companies that become minority CO-INVESTORS alongside Zijin in a shared asset and stay listed**. **Anchored on PUBLIC ANNOUNCEMENT DATES, the seven seasoned situations have a median 7.6x and 5 of 7 beat Zijin's own shares** — Montage Gold **+11.4x (5.7x Zijin)**, Wanguo Gold **+7.6x (3.7x Zijin)**, Zangge **+15.0x (1.67x Zijin)**. The real anchor is **8 Jun 2020**, when Zijin bought **50.1% of Julong Copper** and Zangge kept **30.78%** — **84% of the move came AFTER the announcement**, so it was investable, not hindsight. **But §6 refuses to claim causation:** Western Mining rose ~6.5x with Zijin as a *passive, non-operating* ~22% minority, and the biggest winners are gold names measured through a historic gold bull market — this may be a **screen**, not alpha. **🔴 The second true instance FAILED to beat Zijin:** Zhaojin has the identical structure (Zijin owns **30% of Haiyu** + **18.20% of Zhaojin**) yet returned 0.73x Zijin — because **Julong Phase II commissioned in Jan-2026 and Haiyu still has not** (the word 海域 appears **zero times** in Zhaojin's 23-Aug-2026 interim). **The catalyst is COMMISSIONING, not the announcement.** **🔴 The most decision-relevant new fact: Zijin's binding constraint moved from the host country to CHINA** — Solaris (2024) was killed by Canada's ICA, but **Allied Gold (2026), Zijin's largest-ever deal at C$44.00/sh, was killed by China's own NDRC after Canada had cleared it. No break fee; −18% in a session; and the market already had it at a 33% discount to the offer the day before.** Deep dives on **赤峰黄金** (net cash, 41% operating margin, net profit **6.8x in 3 yrs**, **H-share 25.6% cheaper than A** — but growth is 100% gold price and H1-26 volumes fell 9.45%), **招金矿业** (a leveraged Haiyu option: **H1-26 mined gold −21.87%**, no interim dividend, ¥5.39bn of perpetuals inside equity) and **Allied Gold** (**Q1-26 AISC US$2,264/oz, +69% vs Agnico**, 1.13–1.49 g/t grades, loss-making FY24 **and** FY25, with Kurmuk feeding first ore Sep-2026). Full Two-Step Protocol, gold operating-leverage model, **three corrections to my own work kept visible** (including a 3.5x data conflict that turned out to be a 1-for-4 split). *Analysis, not investment advice.*

**📊 PART II added Sep 18 — full fundamental chapters on all three, with calibrated target prices.** The headline finding: **business quality and investment attractiveness are INVERTED.** **赤峰黄金** has the best business (net cash, 27% ROE, 1.8x cash conversion, FY2023 AISC US$1,179/oz) **and the worst risk/reward** — base case **−14%** because it is the most expensive on every asset metric (**EV/production oz US$21,746**) while volumes FALL (H1-26 −9.45%). **招金矿业** has the **best skew** (−21% / **+40%** / +129%), the best grade (Haiyu **4.2 g/t**) and the cheapest reserves (**US$566/oz**) — but **Haiyu still has not started** and the word 海域 appears **zero times** in its 23-Aug-2026 interim. **Allied Gold** is cheapest on assets (**EV/production oz US$8,479**, FCF yield 4.7%) with the biggest upside (**+157%**) **and the biggest hole (−64%)** — Q1-26 AISC **US$2,264/oz** on unfixable 1.13–1.49 g/t grades. **Two method fixes make the numbers trustworthy:** the multiple **falls** as gold rises (12x→10x→7x, since applying a bull multiple to bull earnings double-counts optimism), and every scenario is **calibrated against FY2025 actuals** — the bridge fits Chifeng to −5% but says Allied should have earned **+US$270m** when it actually **lost US$63m**, a **US$333m gap AISC cannot see. AISC is not profit.** Includes Day1Global Modules C/L/O, a pre-mortem and an anti-bias check.

**[📄 Following Zijin (EN) →](zijin_stakes/report_en)** | **[跟着紫金（中文）→](zijin_stakes/report_cn)** | **[data + code →](https://github.com/liqiqiii/VLCC-Analysis-2026/tree/master/zijin_stakes)**

---

### 🏛️📉 Volcker vs Warsh — Did the Latin Debt Crisis End the High-Rate Regime? (NEW — Sep 17, 2026)

Tests a sharp analogy — *Russia-Ukraine ≈ 1st oil crisis, US-Iran ≈ 2nd oil crisis, Warsh's hike ≈ the 1979 Volcker moment* — and asks what actually ends a tightening regime. **Verdict: the Latin American debt crisis did NOT end Volcker's high rates.** The Board voted **cut #1 on Jul 19, 1982 and cut #2 on Jul 30 — 24 and 13 days BEFORE** Mexico's Aug 12 default call; fed funds had already fallen **−1.56pp in July**. Then, decisively: the Board **REFUSED a cut on Sep 13, 1982** at the height of the crisis, and the Fed **re-tightened +3.13pp** (8.51% Feb-83 → **11.64% Aug-84**) *while the crisis worsened* — at the **Brady Plan (Mar-1989) fed funds was 9.85%, HIGHER than the 1983 trough.** What ended it was **delivered disinflation** (CPI 14.8% → 3.8%) paid for with a **10.8% unemployment** recession; Mexico got **swap lines and forbearance, not rate cuts**. **Modern control: the Fed HIKED 25bp eleven days after SVB failed (Mar-2023), +0.55pp straight through the banking crisis.** So for today: at Volcker's pivot the **real policy rate was +6.0pp; Warsh's is +0.2pp** — he is at the **1979 starting line, not the 1982 finish line**, and the **1980 false dawn** (−8.58pp cut at a −4.12pp real rate, then a forced +9.87pp re-hike) is why he will stop **late**. **The most likely thing that slows him is Hormuz reopening, not a debt crisis** — and ⚠️ **that is the same event as the VLCC super-spike collapsing**, so "Fed pause" and "tanker boom" are *one bet, opposite sides*. Full Two-Step Protocol, primary Fed sources (1982 Annual Report, FOMC transcripts, Bulletins), reproducible FRED model + 3-panel chart. *Analysis, not investment advice.*

**[📄 Volcker vs Warsh (EN) →](volcker_warsh/report_en)** | **[沃尔克 vs 沃什（中文）→](volcker_warsh/report_cn)** | **[data + code →](https://github.com/liqiqiii/VLCC-Analysis-2026/tree/master/volcker_warsh)**
